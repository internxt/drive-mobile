...
function SortModal(props: any) {
  ...
  >
    ...
    <Text
      ...
      onPress={() => onSortTypePressed(sortTypes.DATE_ADDED)}>{strings.components.app_menu.filter.date}</Text>
    <Text
      style={
      ...
      onPress={() => onSortTypePressed(sortTypes.SIZE_ASC)}>{strings.components.app_menu.filter.size}</Text>
    <Text
      style={
      ...
      onPress={() => onSortTypePressed(sortTypes.NAME_ASC)}>{strings.components.app_menu.filter.name}</Text>
    <Text
      style={
      ...
      onPress={() => onSortTypePressed(sortTypes.FILETYPE_ASC)}>{strings.components.app_menu.filter.type}</Text>
  </Modal>
}
