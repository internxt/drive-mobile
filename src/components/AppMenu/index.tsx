  ...
  return (
    <>
      <View style={tailwind('px-5 pt-4')}>
        <View
          style={[
            tailwind('flex-row items-center justify-between my-2'),
            (props.hideNavigation || isRootFolder) && tailwind('hidden'),
          ]}
        >
          <View>
            <TouchableOpacity
            ...
            >
              <View
                style={[
                  ...
                  tailwind(!(parentFolderId || props.onBackPress) && 'opacity-50'),
                ]}
              >
          ...
          >
            <View style={tailwind('flex-row items-center')}>
              <Text style={tailwind('text-neutral-100')}>
                {strings.screens.file_explorer.sort[props.filesState.sortType]}
              </Text>
