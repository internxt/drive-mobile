...
const statements = {
  createIndex: `CREATE UNIQUE INDEX IF NOT EXISTS photo_name ON ${TABLE_NAME} (photo_name);`,
  ...
  updatePhotoById: `UPDATE ${TABLE_NAME} SET photo_name = ?, photo_hash = ?, photo_taken_at = ?, photo = ? WHERE photo_id = ? `,
};
