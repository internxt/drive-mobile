...
const B = props => (
  <Text style={{ fontWeight: 'bold', color: '#2c2c2c' }}>{props.children}</Text>
);
...
const slides = [
  ...
  },
  {
    ...
    text: (
      <Text>
        Access Internxt Drive from our <B>Desktop</B>, <B>Web</B> or{' '}
        <B>Mobile</B> app. Start using Internxt Drive today with <B>2 GB</B> on
        us. <B>Upgrade your storage</B> only if you need to, from our Web app.
      </Text>
    ),
