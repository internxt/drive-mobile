export const photoActionTypes = {
  ...
  SET_LOCAL_PHOTOS: 'SET_LOCAL_PHOTOS',
  SET_UPLOADED_FOTOS: 'SET_UPLOADED_FOTOS',
  PUSH_PREVIEW: 'PUSH_PREVIEW',
  CLEAR_LOCAL_PHOTOS: 'CLEAR_LOCAL_PHOTOS',
  SET_LOCAL_PHOTOS_GALLERY: 'SET_LOCAL_PHOTOS_GALLERY',
