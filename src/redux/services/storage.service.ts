...
async function loadAvailableProducts(userToken: string): Promise<IProduct[]> {
...
async function loadAvailablePlans(userToken: string, productId: string): Promise<IPlan[]> {
  const body = {
    product: productId,
