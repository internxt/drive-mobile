    ...
    screens: {
      ...
      compose_email: {
        ...
        draft: {
          ...
          attachmentsNotSaved: 'Attachments added here are sent with the message, but not saved in the draft.',
    ...
    screens: {
      ...
      compose_email: {
        ...
        draft: {
          ...
          attachmentsNotSaved:
            'Los adjuntos que añadas aquí se envían con el mensaje, pero no se guardan en el borrador.',
