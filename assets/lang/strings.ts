  ...
  en: {
    ...
    screens: {
      ...
      email_detail: {
        date: 'Date',
        toMe: 'to me',
        toMeAndOthers: 'to me and {0} more',
        toRecipient: 'to {0}',
        toRecipientAndOthers: 'to {0} and {1} more',
        showDetails: 'Show details',
        hideDetails: 'Hide details',
        attachmentCount: '{0} attachments',
        singleAttachment: '1 attachment',
        messageCount: '{0} messages',
        moreMessages: '{0} more messages',
        ...
        deleteConfirmation: {
          ...
          message: 'This conversation will be deleted and cannot be recovered.',
          confirm: 'Delete',
        },
        actions: {
          reply: 'Reply',
      ...
      compose_email: {
        ...
        draft: {
          ...
          openFailed: 'The draft could not be opened.',
          discardFailed: 'The draft could not be discarded.',
          saving: 'Saving draft…',
          discarding: 'Discarding draft…',
          leaveWithoutSaving: 'Leave without saving',
          notSaved: 'The draft could not be saved. It will be tried again as you keep writing.',
          notFound: 'This draft no longer exists.',
          uploadingAttachments: 'Uploading attachments…',
          attachmentsNotUploaded: '{0} attachments could not be uploaded and will not be kept in the draft.',
          leaveWithoutAttachments: 'Leave without them',
          attachmentNotUploaded: 'An attachment could not be uploaded and will not be kept in the draft.',
        },
        attachments: {
          remove: 'Remove',
          retry: 'Retry',
        ...
        errors: {
          ...
          sendRateLimited: "You've reached the sending limit for now. Try again in a while.",
          sendRateLimitedDraftSaved:
            "You've reached the sending limit for now. The message was kept in Drafts, send it again in a while.",
      ...
      ShareExtension: {
        ...
        cancelUploadMessage: 'The files have not been uploaded yet.',
        cancelUploadConfirm: 'Cancel upload',
        cancelUploadNo: 'Keep uploading',
        handoffErrorTitle: 'Something went wrong',
        handoffErrorMessage: 'The files could not be prepared for upload. Please try sharing again.',
      },
    },
    buttons: {
      send: 'Send',
  ...
  es: {
    ...
    screens: {
      ...
      email_detail: {
        date: 'Fecha',
        toMe: 'para mí',
        toMeAndOthers: 'para mí y {0} más',
        toRecipient: 'para {0}',
        toRecipientAndOthers: 'para {0} y {1} más',
        showDetails: 'Mostrar detalles',
        hideDetails: 'Ocultar detalles',
        attachmentCount: '{0} adjuntos',
        singleAttachment: '1 adjunto',
        messageCount: '{0} mensajes',
        moreMessages: '{0} mensajes más',
        ...
        deleteConfirmation: {
          ...
          message: 'Esta conversación se eliminará y no se podrá recuperar.',
          confirm: 'Eliminar',
        },
        actions: {
          reply: 'Responder',
      ...
      compose_email: {
        ...
        draft: {
          ...
          saveFailed: 'No se ha podido guardar el borrador.',
          openFailed: 'No se ha podido abrir el borrador.',
          discardFailed: 'No se ha podido descartar el borrador.',
          saving: 'Guardando borrador…',
          discarding: 'Descartando borrador…',
          leaveWithoutSaving: 'Salir sin guardar',
          notSaved: 'No se ha podido guardar el borrador. Se volverá a intentar mientras sigues escribiendo.',
          notFound: 'Este borrador ya no existe.',
          uploadingAttachments: 'Subiendo adjuntos…',
          attachmentsNotUploaded: 'No se han podido subir {0} adjuntos y no se guardarán en el borrador.',
          leaveWithoutAttachments: 'Salir sin ellos',
          attachmentNotUploaded: 'No se ha podido subir un adjunto y no se guardará en el borrador.',
        },
        attachments: {
          remove: 'Quitar',
          retry: 'Reintentar',
        ...
        errors: {
          ...
          sendRateLimited: 'Has alcanzado el límite de envío por ahora. Inténtalo de nuevo dentro de un rato.',
          sendRateLimitedDraftSaved:
            'Has alcanzado el límite de envío por ahora. El mensaje se ha guardado en Borradores; envíalo de nuevo dentro de un rato.',
          forwardedAttachmentUnavailable:
      ...
      ShareExtension: {
        ...
        cancelUploadMessage: 'Los archivos aún no se han subido.',
        cancelUploadConfirm: 'Cancelar subida',
        cancelUploadNo: 'Seguir subiendo',
        handoffErrorTitle: 'Algo ha ido mal',
        handoffErrorMessage: 'No se pudieron preparar los archivos para la subida. Por favor, inténtalo de nuevo.',
      },
    },
    buttons: {
      send: 'Enviar',
    ...
    modals: {
      ...
      SignOutModal: {
        ...
        signingOutGeneric: 'Cerrando sesión…',
      },
      ConfirmMoveItemModal: {
